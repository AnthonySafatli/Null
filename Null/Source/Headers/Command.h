...
private:
	...
	/* Files */														   
	static void Open(const std::vector<std::string> args);             // opens files and editor
	static void Save(const std::vector<std::string> args);             // saves files
	static void Rename(const std::vector<std::string> args);           // renames the opened file
